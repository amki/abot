...
var ping = function(abot) {
    ...
    command.addCommand({command: "ping", access: Discord.Permissions.FLAGS.SEND_MESSAGES, handler: async function(msg, args) {
    ...
    command.addCommand({command: "say", access: Discord.Permissions.FLAGS.KICK_MEMBERS,handler: async function(msg, args) {
    ...
    command.addCommand({command: "deny", access: Discord.Permissions.FLAGS.KICK_MEMBERS, handler: async function(msg, args) {
