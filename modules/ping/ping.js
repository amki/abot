var ping = function(abot) {
    ...
    command.addCommand("ping","everyone",async function(msg, args) {
    ...
    command.addCommand("echo","everyone",async function(msg, args) {
    ...
    command.addCommand("say","admin",async function(msg, args) {
    ...
    command.addCommand("deny","asdasd",async function(msg, args) {
